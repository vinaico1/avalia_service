  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-brand-700 to-brand-900">
      ...
      <div className="bg-white rounded-t-3xl px-6 pt-8 pb-safe pb-10 shadow-2xl">
        ...
        {/* Social buttons — desabilitados até configurar no Supabase */}
        <div className="space-y-3 mb-6 opacity-40 pointer-events-none select-none">
          <div className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 rounded-xl py-3.5 font-semibold text-gray-400 bg-gray-50 cursor-not-allowed">
          ...
          <div className="w-full flex items-center justify-center gap-3 bg-gray-300 text-gray-400 rounded-xl py-3.5 font-semibold cursor-not-allowed">
